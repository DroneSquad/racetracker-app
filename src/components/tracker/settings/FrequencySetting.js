  ...
  render() {
    ...
    return (
      <div className={'frequencies ' + this.isLoadingClass()}>
        <ListItem hoverColor="rgba(0, 0, 0, 0)" leftIcon={<FontIcon className="mdi mdi-radio-tower"/>} primaryText="Frequencies" secondaryText={frequencies} onTouchTap={this.openFrequencies}/>
      </div>
    );
  }
}
